...
def getRequestSession(username, password):
    ...
    loginScreenResponse = requestSession.get("https://denhac.dentonisd.org/HomeAccess/Account/LogOn?ReturnUrl=%2fHomeAccess%2f").text
    ...
    pageDOM = requestSession.post(
        "https://denhac.dentonisd.org/HomeAccess/Account/LogOn?ReturnUrl=%2fHomeAccess%2f",
        data=requestPayload,
